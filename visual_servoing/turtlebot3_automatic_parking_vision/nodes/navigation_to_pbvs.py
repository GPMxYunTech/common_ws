...
class navigation_to_pbvs():
    def __init__(self, command):
        self.start_node = rospy.Subscriber('start_node', Int8, self.cbstart_node, queue_size = 100)
        self.start_node = rospy.Subscriber('wait', Bool, self.cbwait, queue_size = 100)
        self.goal_pub = rospy.Publisher('move_base_simple/temp_goal', PoseStamped, queue_size=100)
