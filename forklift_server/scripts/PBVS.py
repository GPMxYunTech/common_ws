...
class PBVS():
    ...
    def __init__(self, _as, Subscriber, Sequence, init_fork):
        self._as = _as
    ...
    def PBVS(self):
        ...
        # ============down_fork============
            ...
            self.is_sequence_finished = self.Action.fork_updown(0.647)
            ...
            self.is_sequence_finished = self.Action.back(1.2)
