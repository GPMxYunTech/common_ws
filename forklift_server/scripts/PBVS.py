...
class PBVS():
    ...
    def PBVS(self):
        ...
        # ============up_fork============
            ...
            self.is_sequence_finished = self.Action.fnseqmove_to_marker_dist(1.0)
            ...
            self.is_sequence_finished = self.Action.fnseqdead_reckoning(2.0)
        ...
        # ============down_fork============
            ...
            self.is_sequence_finished = self.Action.fnseqmove_to_marker_dist(0.95)
